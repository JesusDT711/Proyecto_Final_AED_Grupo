 ...
 * @author adria
 */
public class fmrClienteAdd extends javax.swing.JFrame {

    /**
     * Creates new form fmrClienteAdd
     */
    public fmrClienteAdd() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fmrClienteAdd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new fmrClienteAdd().setVisible(true);
            }
        });
    }
