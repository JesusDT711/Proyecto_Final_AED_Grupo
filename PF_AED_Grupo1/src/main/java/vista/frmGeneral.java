...
public class frmGeneral extends javax.swing.JFrame {
    ...
    public frmGeneral() {
        initComponents();
        //método para cargar los productosBase en la tabla
        cargarProductosBase();

        //Para habilitar los botones de la pestaña Productos
    ...
    private void btnIngresaAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresaAActionPerformed
        ...
        frmProductAdd ventana = new frmProductAdd();
    ...
    private void btnActualizaAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizaAActionPerformed
        ...
        frmProductAdd ventana = new frmProductAdd(producto); // pasa el producto existente mediante el objeto
