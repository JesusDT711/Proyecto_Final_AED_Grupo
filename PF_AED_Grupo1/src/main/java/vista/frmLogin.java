...
public class frmLogin extends javax.swing.JFrame {
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        // Nota: Para verificar JPasswordField, se usa getPassword().length
        if (!txtUsuario.getText().trim().isEmpty() && psContraseña.getPassword().length > 0) {

            String usuario = txtUsuario.getText();

            // 2. CORRECCIÓN CRÍTICA DE SEGURIDAD: Usar getPassword() y convertir a String
            String contraseña = new String(psContraseña.getPassword()); // CORRECTO

            if (usuario.equals(oUsuario.getUsuario()) && contraseña.equals(oUsuario.getContraseña())) {

                // NOTA: Asegúrate de que la clase frmGeneral esté importada o en el mismo paquete
            ...
            // 3. MEJORA DE SEGURIDAD: Limpiar el array de caracteres (opcional, pero buena práctica)
